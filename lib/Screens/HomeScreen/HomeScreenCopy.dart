                                            ...
                                            children: [
                                              Row(
                                                ...
                                                /*  InkWell(
                                                    ...
                                                    child: Image(
                                                      image: AssetImage('assets/images/user1.png',), fit: BoxFit.cover,
                                                      height: 59,
                                                      width: 59,
                                                    ),
                                                  ),*/
                                                  ...
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      Text("good morning", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.5)),),
                                                      SizedBox(
                                                        height: 5,
                                                      ),
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        if((userData.data.address1 != "" || userData.data.address1 != null) && userData.data.verified == 'f')...[
                                          Container(
                                            child: Center(
                                              child: Text("Aaccount awaiting verification by admin.", style: TextStyle(color: Colors.red),),
                                            ),
                                          )
