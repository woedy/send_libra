...
class AddReceiverGetPaidScreen extends StatefulWidget {
  final data;
  const AddReceiverGetPaidScreen({Key? key, required this.data}) : super(key: key);

  @override
  State<AddReceiverGetPaidScreen> createState() => _AddReceiverGetPaidScreenState();
}
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("How they get\npaid", style: TextStyle(fontSize: 36),),
                                  SizedBox(
                                    height:40,
                                  ),
                                    ...
                                    child: ListView(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              selectedItemIndex = 0; // Set the index of the selected item
                                            });
                                          },
                                          child: Container(
                                            padding: EdgeInsets.all(10),
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                              border: Border.all(
                                                color: selectedItemIndex == 0 ? Colors.blue : Colors.transparent,
                                                width: 1,
                                              ),
                                              color: selectedItemIndex == 0 ? clay : Colors.transparent,
                                            ),
                                            child: Column(
                                              children: [
                                                Container(
                                        ...
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              selectedItemIndex = 1; // Set the index of the selected item
                                            });
                                          },
                                          child: Container(
                                            padding: EdgeInsets.all(10),
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                              border: Border.all(
                                                color: selectedItemIndex == 1 ? Colors.blue : Colors.transparent,
                                                width: 1,
                                              ),
                                              color: selectedItemIndex == 1 ? clay : Colors.transparent,
                                            ),
                                            child: Column(
                                              children: [
                                                Container(
                                        ...
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              selectedItemIndex = 2; // Set the index of the selected item
                                            });
                                          },
                                          child: Container(
                                            padding: EdgeInsets.all(10),
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                              border: Border.all(
                                                color: selectedItemIndex == 2 ? Colors.blue : Colors.transparent,
                                                width: 1,
                                              ),
                                              color: selectedItemIndex == 2 ? clay : Colors.transparent,
                                            ),
                                            child: Column(
                                              children: [
                                                Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Transfer Number", style: TextStyle(fontSize: 12),),
                              SizedBox(
                                height: 20,
                              ),
                              Container(
