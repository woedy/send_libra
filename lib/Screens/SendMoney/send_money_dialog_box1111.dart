...
class LoadingVerificationDialog1 extends StatefulWidget {
  ...
  const LoadingVerificationDialog1({Key? key, required this.amount, required this.full_name, required this.mobile, this.initials, this.image, required this.onCountdownComplete}) : super(key: key);
                ...
                children: [
                  Row(
                    children: [
                      Checkbox(
                        ...
                        onChanged: (newValue) {
                          setState(() {
                            ...
                            if (addToQuickSend) {
                              quickSendList.add({
                                "benef_id": 26, // Example data
                                "payment_method": 41, // Example data
                      ...
                      SizedBox(width: 10),
                      Text("Add to quick send", style: TextStyle(color: Colors.blue)),
                    ],
                  ),
                  InkWell(
                    onTap: (){
                      print("wWOOOOOOOOOOOOOOOOOO");
                      if (mounted) {
                        setState(() {
