...
class _PdfGeneratePageState extends State<PdfGeneratePage> {
  ...
  Future<void> _generatePdf() async {
        ...
        build: (context) {
          return pdfLib.Column(
            ...
            children: [
              ...
              pdfLib.Text('Beneficiary Name: ${widget.data['benef_name']}'),
              pdfLib.Text('Amount: ${widget.data['send_amount']} ${widget.data['send_currency']}'),
    ...
    final file = File('${directory}/${widget.data['trans_ref']}-${widget.data['benef_name']}.pdf');
