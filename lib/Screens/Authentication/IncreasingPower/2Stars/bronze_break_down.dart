...
import 'package:send_libra/Screens/Authentication/IncreasingPower/2Stars/2_star_information_needed.dart';
import 'package:send_libra/constants.dart';


class BronzePowerBreakdown extends StatefulWidget {
  const BronzePowerBreakdown({Key? key}) : super(key: key);

  @override
  State<BronzePowerBreakdown> createState() => _BronzePowerBreakdownState();
}

class _BronzePowerBreakdownState extends State<BronzePowerBreakdown> {
  @override
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("£5,000", style: TextStyle(fontSize: 16, color: libraPrimary),),
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("£15,000", style: TextStyle(fontSize: 16, color: libraPrimary),),
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("£20,000", style: TextStyle(fontSize: 16, color: libraPrimary),),
                                  ...
                                  Align(
                                    child: Container(
                                      ...
                                      child: Material(
                                        ...
                                        child: InkWell(
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => BronzeInformation()));
