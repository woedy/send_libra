...
import 'package:send_libra/Screens/Authentication/IncreasingPower/4Stars/4_star_information_needed.dart';
import 'package:send_libra/constants.dart';


class SilverPlusPowerBreakdown extends StatefulWidget {
  const SilverPlusPowerBreakdown({Key? key}) : super(key: key);

  @override
  State<SilverPlusPowerBreakdown> createState() => _SilverPlusPowerBreakdownState();
}

class _SilverPlusPowerBreakdownState extends State<SilverPlusPowerBreakdown> {
  @override
                                  ...
                                  Align(
                                    child: Container(
                                      ...
                                      child: Material(
                                        ...
                                        child: InkWell(
                                          onTap: (){
                                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SilverPlusInformation()));
