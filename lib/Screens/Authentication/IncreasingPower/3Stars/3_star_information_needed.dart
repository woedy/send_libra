...
class SilverInformation extends StatefulWidget {
  const SilverInformation({Key? key}) : super(key: key);

  @override
  State<SilverInformation> createState() => _SilverInformationState();
}

class _SilverInformationState extends State<SilverInformation> {
  @override
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text("Photo ID", style: TextStyle(fontSize: 18, color: libraPrimary, fontWeight: FontWeight.bold),),
                                            SizedBox(
                                              height: 10,
                                            ),
